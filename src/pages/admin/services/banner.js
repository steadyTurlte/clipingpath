...
const ServicesBannerEditor = () => {
  ...
  useEffect(() => {
    ...
    const fetchBannerData = async () => {
      try {
        const response = await fetch('/api/content/services?section=banner');
  ...
  return (
    <AdminLayout>
      <Head>
        <title>Edit Services Banner | Photodit Admin</title>
      </Head>

      <div className="admin-editor">
        <div className="admin-editor__header">
          <h1 className="admin-editor__title">Edit Services Banner</h1>
...
export default ServicesBannerEditor;
