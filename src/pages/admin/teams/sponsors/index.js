...
const TeamSponsorsEditor = () => {
  ...
  useEffect(() => {
    const fetchSponsorsData = async () => {
      try {
        const response = await fetch('/api/content/teams?section=sponsors');
        if (response.ok) {
        ...
        setError('Error loading sponsors data');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError('Failed to save Sponsors section');
      }
    } catch (error) {
  ...
  return (
    <AdminLayout>
      <Head>
        <title>Edit Team Sponsors | Photodit Admin</title>
      </Head>

      <div className="admin-editor">
        <div className="admin-editor__header">
          <h1 className="admin-editor__title">Edit Team Sponsors</h1>
        ...
        <div className="admin-editor__content">
          <div className="admin-editor__section">
            <h2 className="admin-editor__section-title">Sponsors Section Settings</h2>
          ...
          <div className="admin-editor__section">
            ...
            <p className="admin-editor__description">
              Manage your sponsor logos here. You can add, edit, or remove sponsor logos.
            </p>

            <div className="admin-editor__message">
              <p>Sponsor logos editor will be implemented soon.</p>
            </div>
          </div>
        </div>
      </div>
