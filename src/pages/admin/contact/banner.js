...
const ContactBannerEditor = () => {
  ...
  useEffect(() => {
    ...
    const fetchBannerData = async () => {
      try {
        const response = await fetch('/api/content/contact?section=banner');
  ...
  return (
    <AdminLayout>
      <Head>
        <title>Edit Contact Banner | Photodit Admin</title>
      </Head>

      <div className="admin-editor">
        <div className="admin-editor__header">
          <div className="admin-editor__title-wrapper">
            <Link href="/admin/contact" className="admin-editor__back-link">
              <i className="fa-solid fa-arrow-left"></i>
            </Link>
            <h1 className="admin-editor__title">Edit Contact Banner</h1>
          </div>
...
export default ContactBannerEditor;
